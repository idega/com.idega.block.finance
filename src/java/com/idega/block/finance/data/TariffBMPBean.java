...
public class TariffBMPBean extends com.idega.data.GenericEntity implements com.idega.block.finance.data.Tariff {
  ...
  public void initializeAttributes() {
    ...
    addAttribute(getColumnTariffGroup(),"Group",true,true,Integer.class,"many-to-one",TariffGroup.class);    addAttribute(getColumnName(),"Name",true,true,java.lang.String.class);
    addAttribute(getColumnPrice(), "Price", true, true, java.lang.Float.class);
    addAttribute(getColumnInfo(),"Info",true,true,java.lang.String.class,4000);
    addAttribute(getColumnAccountKeyId(),"Accountkey",true,true,java.lang.Integer.class,"one-to-many",com.idega.block.finance.data.AccountKey.class);
    ...
    addAttribute(getColumnAttribute(),"Attribute",true,true,java.lang.String.class);
    addAttribute(getColumnUseIndex(),"Use index",true,true,java.lang.Boolean.class);
    addAttribute(getColumnInUse(),"In Use",true,true,java.lang.Boolean.class);
    addAttribute(getColumnIndexType(),"Index type",true,true,java.lang.String.class,10);
    addAttribute(getColumnIndexUpdated(),"Index updated",true,true,java.sql.Timestamp.class);

  }
  public static String getTariffEntityName(){return "FIN_TARIFF";}
  public static String getColumnTariffGroup(){return "FIN_TARIFF_GROUP_ID";}
  public static String getColumnAccountKeyId(){return "FIN_ACC_KEY_ID";}
  ...
  public static String getColumnInUse(){return "IN_USE";}
  public static String getColumnUseIndex(){return "USE_INDEX";}
  public static String getColumnAttribute(){return "ATTRIBUTE";}
   public static String getColumnIndexType(){return "INDEX_TYPE";}
   public static String getColumnIndexUpdated(){return "INDEX_UPDATED";}
  ...
  public java.util.Collection ejbFindAllByPrimaryKeyArray(String[] array)throws javax.ejb.FinderException{
  ...
  public java.util.Collection ejbFindAllByColumnOrdered(String column,String value,String order)throws javax.ejb.FinderException{
    return super.idoFindAllIDsByColumnOrderedBySQL(column,value,order);
  }

  public java.util.Collection ejbFindAllByColumnOrdered(String column,String value,String column2,String value2,String order)throws javax.ejb.FinderException{
    return super.idoFindAllIDsByColumnOrderedBySQL(column,value,order);
  }

  public java.util.Collection ejbFindAllByColumn(String column,String value)throws javax.ejb.FinderException{
